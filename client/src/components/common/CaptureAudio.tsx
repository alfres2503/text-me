...
const CaptureAudio = ({ hide }) => {
  ...
  return (
    <div className="flex text-2xl w-full justify-end items-center">
      <div className="pt-1">
        <FaTrash className="text-zinc-400" onClick={() => hide()}></FaTrash>
      </div>
      <div className="mx-4 py-2 px-4 text-white text-lg flex gap-3 justify-center items-center bg-zinc-900 rounded-full drop-shadow-lg">
        {isRecording ? (
      ...
      <div>
        <MdSend
          className="text-zinc-300 cursor-pointer mr-4"
          title="Send"
